...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type dd_movement(dd_movementSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(sim_fish(length_at_age, weight_at_age, maturity_at_age, f_p_a, seasonal_movement, movement_seasons, dd_movement, last_n_p_a, patches, burn_steps, time_step, season, steepness, r0s, ssb0, ssb0_p, m_at_age, tune_unfished, rec_form));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_marlin_sim_fish", (DL_FUNC) &_marlin_sim_fish, 19},
    {NULL, NULL, 0}
};
